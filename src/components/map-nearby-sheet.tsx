...
/**
 * Panel „W pobliżu" pod mapą — zwinięty pokazuje pasek uchwytu + 1 wiersz, po
 * dotknięciu rozwija się do listy. Celowo BEZ stanu ładowania/szkieletu —
 * wcześniejsza wersja pokazywała 3 pulsujące wiersze podczas ładowania i
 * chowała się do null, gdy okazywało się, że boisk w pobliżu jednak nie ma —
 * przy szybkim preładowaniu to migotanie (panel wyskakuje i po chwili znika)
 * wyglądało jak błąd, nie jak loading state. Po prostu nic nie pokazujemy,
