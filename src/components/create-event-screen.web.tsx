...
export default function CreateEventScreen() {
  ...
  // map-view.web.tsx), bo tu też wybiera się lokalizację, którą i tak serwer
  ...
  const cameraRef = useRef<CameraImperative>(null);
  const fullCameraRef = useRef<CameraImperative>(null);
 ...
 * map-view.web.tsx. `id` musi być unikalny per instancja ShapeSource (mapa
