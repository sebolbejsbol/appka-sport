-- ═══════════════════════════════════════════════════════════════════════════
-- 0028 — Znajomi = wzajemne obserwowanie
-- Kategoria: Społeczność  |  Typ: BASE  |  Wymaga: 0026
-- Plik: supabase/migrations/0028_mutual_follow_friends.sql
-- SQL Editor: 0028 — wzajemne obserwowanie
-- ═══════════════════════════════════════════════════════════════════════════
