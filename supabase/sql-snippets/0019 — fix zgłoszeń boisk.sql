-- ═══════════════════════════════════════════════════════════════════════════
-- 0019 — Fix: zgłoszenia boisk
-- Kategoria: Boiska  |  Typ: FIX  |  Wymaga: 0018
-- Plik: supabase/migrations/0019_field_reports_fix.sql
-- SQL Editor: 0019 — fix zgłoszeń boisk
-- ═══════════════════════════════════════════════════════════════════════════
-- Uruchamiaj w kolejności numerów. Skrypt idempotentny (bezpieczny ponownie).
-- UWAGA: migracja naprawcza — uruchom po 0018.
-- Zastępuje w SQL Editor: "naprawka do migracji 0018", "druga poprawka do 18"
