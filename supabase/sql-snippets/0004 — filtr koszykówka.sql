-- ═══════════════════════════════════════════════════════════════════════════
-- 0004 — Filtr boisk: koszykówka (podstawowy)
-- Kategoria: Boiska  |  Typ: BASE  |  Wymaga: 0002
-- Plik: supabase/migrations/0004_filter_basketball.sql
-- SQL Editor: 0004 — filtr koszykówka
-- ═══════════════════════════════════════════════════════════════════════════
