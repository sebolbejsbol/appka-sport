-- ═══════════════════════════════════════════════════════════════════════════
-- 0017 — Push notifications (Expo)
-- Kategoria: Powiadomienia  |  Typ: BASE  |  Wymaga: 0001
-- Plik: supabase/migrations/0017_push_notifications.sql
-- SQL Editor: 0017 — push notifications
-- ═══════════════════════════════════════════════════════════════════════════
