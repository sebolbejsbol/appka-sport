-- ═══════════════════════════════════════════════════════════════════════════
-- 0034 — Drużyny: messages, eventy, storage
-- Kategoria: Drużyny  |  Typ: FIX  |  Wymaga: 0032
-- Plik: supabase/migrations/0034_teams_migration_continue.sql
-- SQL Editor: 0034 — drużyny · dokończenie
-- ═══════════════════════════════════════════════════════════════════════════
-- Uruchamiaj w kolejności numerów. Skrypt idempotentny (bezpieczny ponownie).
-- UWAGA: migracja naprawcza — uruchom po 0032.
