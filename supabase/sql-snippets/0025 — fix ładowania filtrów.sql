-- ═══════════════════════════════════════════════════════════════════════════
-- 0025 — Fix: ładowanie filtrów eventów
-- Kategoria: Eventy  |  Typ: FIX  |  Wymaga: 0024
-- Plik: supabase/migrations/0025_event_filters_load_fix.sql
-- SQL Editor: 0025 — fix ładowania filtrów
-- ═══════════════════════════════════════════════════════════════════════════
-- Uruchamiaj w kolejności numerów. Skrypt idempotentny (bezpieczny ponownie).
-- UWAGA: migracja naprawcza — uruchom po 0024.
