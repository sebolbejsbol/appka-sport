-- ═══════════════════════════════════════════════════════════════════════════
-- 0022 — Moderacja boisk (rozszerzona)
-- Kategoria: Admin  |  Typ: BASE  |  Wymaga: 0013
-- Plik: supabase/migrations/0022_admin_fields_moderation.sql
-- SQL Editor: 0022 — moderacja boisk
-- ═══════════════════════════════════════════════════════════════════════════
