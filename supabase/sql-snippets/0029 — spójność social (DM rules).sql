-- ═══════════════════════════════════════════════════════════════════════════
-- 0029 — Spójność social (DM rules, wspólne eventy)
-- Kategoria: Społeczność  |  Typ: BASE  |  Wymaga: 0027, 0028
-- Plik: supabase/migrations/0029_social_cohesion.sql
-- SQL Editor: 0029 — spójność social (DM rules)
-- ═══════════════════════════════════════════════════════════════════════════
