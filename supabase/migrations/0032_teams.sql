-- Migracja 0032: drużyny sportowe, czat drużyny, zaproszenia na eventy
-- Wymaga: 0026–0031 (profiles, conversations, messages, events).
--
-- Role: owner | admin | member
-- Czat: jedna rozmowa grupowa na drużynę (team_conversations).
