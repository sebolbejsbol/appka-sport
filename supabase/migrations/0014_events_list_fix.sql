-- Migracja 0014: poprawka listy eventów (widoczność jak na boisku)
-- Uruchom w Supabase: SQL Editor → Run.
--
-- Problem: upcoming_events (0012) filtrował po sporcie BOISKA — eventy na boiskach
-- z sport=null lub innym tagiem OSM znikały z listy, choć widać je na mapie / w sheet.
