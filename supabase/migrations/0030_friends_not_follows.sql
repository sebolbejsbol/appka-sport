-- Migracja 0030: znajomi ≠ obserwowanie
-- Znajomi = osobna relacja (zaproszenia / friendships).
-- Obserwowanie = jednostronne (bez listy „Obserwuję” w UI).
-- Wymaga: 0026–0029.

-- Obserwuj (bez wpływu na znajomych)
