-- Migracja 0010: meldowanie GPS na eventach
-- Uruchom w Supabase: SQL Editor → Run.
--
-- Zasady (PLAN.md / SLOWNIK.md):
--  - promień 100 m od boiska,
--  - okno: 20 min przed startem → koniec eventu (starts_at + duration_min),
--  - zameldowanie po starcie = is_late (pod przyszłą rangę),
--  - po zamknięciu okna: tylko organizator/admin może zameldować ręcznie.
